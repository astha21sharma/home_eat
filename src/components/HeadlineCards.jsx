    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6 '>
      ...
      <div className='rounded-xl relative hover:scale-105 duration-300'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <button className='border-white bg-white text-black mx-2 absolute bottom-4 hover:scale-105 duration-300'>Order Now</button>
        </div>
        <img
        className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl '
          src='https://imgk.timesnownews.com/story/paratha_0.gif'
          alt='/'
        />
      </div>
      {/* Card */}
      <div className='rounded-xl relative hover:scale-105 duration-300'>
        {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Moms Magic</p>
