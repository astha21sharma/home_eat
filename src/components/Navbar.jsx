...
//             F<span className='font-bold'>oo</span>dies
//         </h1>  
...
//             <h2 className='text-2xl p-4'>F<span className='font-bold'>oo</span>dies</h2>
...
//               <li className='text-xl py-4 flex'><BsFillSaveFill size={25} className='mr-4'/>Best once</li>
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
          Home <span className='font-bold'>Eats</span>
        </h1>
        <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
          <p className='bg-black text-white rounded-full p-2'>Delivery</p>
          <p className='p-2'>Pickup</p>
